																		...
																		Column(
																			...
																			children: [
																				Container(
																						...
																						child: Text('Order ${edge['node']['name']}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold),)
																				),
																				...
																				Row(
																					children: [
																						...
																						Text(DateFormat.yMMMMd().format(DateTime.parse(edge['node']['processedAt'])), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w300),),
																					],
																				),
																				const SizedBox(height: 4,),
																				Row(
																					children: [
																						const Text('Payment status:', style: TextStyle(color: Colors.blueGrey),),
																						const SizedBox(width: 4),
																						Text(edge['node']['financialStatus'],style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w300)),
																					],
																				),
																				const SizedBox(height: 4,),
																				Row(
																					children: [
																						const Text('Fulfillment status:', style: TextStyle(color: Colors.blueGrey),),
																						const SizedBox(width: 4),
																						Text(edge['node']['fulfillmentStatus'],style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w300)),
																					],
																				),
																				const SizedBox(height: 4,),
																				Row(
																					children: [
																						...
																						const SizedBox(width: 4),
																						Text('\₹${edge['node']['totalPrice']['amount']} ${edge['node']['totalPrice']['currencyCode']}',style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w300)),
																					],
																				),
																			],
																		),
